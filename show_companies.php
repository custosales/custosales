...
<body style="font-size:12px">
    ...
    <div id="main_table">
        ...
        <div id="graphHead" style="visibility:hidden;margin:0px">
            <h1><?php print $LANG['graphs_overview']; ?></h1>
        </div>
    ...
    <script type="text/javascript">
        ...
        function saveCompanyContactData(regNumber) {
            ...
            xmlhttpi.open("GET", "modules/sales/save_company_contact_data.php?regNumber=" + regNumber +
                ...
                "&companyPostAddress=" + document.getElementById('companyPostAddress').value, true);
            xmlhttpi.send();
