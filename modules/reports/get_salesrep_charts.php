...
try {
    ...
    echo "User Sales Data was not fetched, because: " . $e->getMessage() . $queryM;
}
...
try {
    ...
    echo "User Sales Data was not fetched, because: " . $e->getMessage() . $queryW;
}
...
try {
    ...
    echo "User Sales Data was not fetched, because: " . $e->getMessage() . $queryD;
}
